...
- `source/content` these files interact with the webpage
- `source/options` these are the Extension's Settings files
- `source/popup` these are the Extension's UI Menu files
- `source/service_worker` these are the Extension's JS files with access to special APIs

## Features

Based on https://github.com/fregante/browser-extension-template
